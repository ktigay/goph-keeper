...
// Source: github.com/ktigay/goph-keeper/internal/server/service/auth (interfaces: Repository)
...
func (m *MockRepository) Create(arg0 context.Context, arg1, arg2 string) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1 string) (*entity.User, error) {
	m.ctrl.T.Helper()
